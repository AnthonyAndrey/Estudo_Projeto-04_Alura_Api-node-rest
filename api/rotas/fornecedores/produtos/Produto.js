...
class Produto {
    ...
    atualizar() {
        ...
        if (Object.keys(dadosParaAtualizar).length === 0) { //se o objeto não tiver nenhum registro pra atualizar ele mostra erro
    ...
    diminuirEstoque() {
        return Tabela.subtrair(
            this.id,
            this.fornecedor,
            'estoque', // aqui estamos passando onde vamos substituir
            this.estoque
        )
    }
